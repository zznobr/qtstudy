...
{ //信号与槽的关联，当函数带有参数时，必须写明参数的类型
    ...
    connect(ui->actAbout,&QAction::triggered,this,&QWMainWind::on_actAbout_triggered);
    //连接about命中信号和自定义on_actAbout_triggered槽函数
}
...
//on_actAbout_triggered 实现弹出窗口
void QWMainWind::on_actAbout_triggered(){
    QMessageBox::about(this,"关于","开发人员信息:张桓瑜");
}
